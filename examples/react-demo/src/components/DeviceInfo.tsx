...
export const MidiPort: React.FC<DeviceInfoProps> = ({ port }) => {
    ...
    <>
      ...
      <div className="device-info">
        <div className="device-details">
          ...
          <strong>State:</strong> {port.state}<br />
        ...
        <div className="device-controls">
          ...
          >
            {port.connection === 'open' ? 'Close Port' : port.connection === 'closed' ? 'Open Port' : 'Pending...'}
          </button>
        </div>
      </div>
    </>
